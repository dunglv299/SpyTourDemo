...
import com.teusoft.adapter.StaggeredAdapter;
...
public class NewFeedFragment extends Fragment {
	...
	private void initView(View v) {
		StaggeredGridView gridView = (StaggeredGridView) v
		...
		StaggeredAdapter adapter = new StaggeredAdapter(getActivity(),
